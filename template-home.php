...
if ( get_theme_mod( 'top_news_display', true ) ) {
	get_template_part( 'template-parts/home-sections/top', 'news' );
}

if ( get_theme_mod( 'banner_news_display', true ) ) {
	$offset_banner_news = '';
	if ( ! get_theme_mod( 'banner_news_category' ) ) {
		if ( get_theme_mod( 'top_news_display', true ) && ! get_theme_mod( 'top_news_category' ) ) {
...
?>
<?php if ( get_theme_mod( 'recent_news_display', true ) || get_theme_mod( 'categories_news_display', true ) ) : ?>
	<!-- main-content area-->
	<section class="spacer main-content">
		<div class="container">
			<div class="row">
				<div class="col-sm-8">
					<?php
					if ( get_theme_mod( 'recent_news_display', true ) ) {
						get_template_part( 'template-parts/home-sections/recent', 'news' );
					}

					if ( get_theme_mod( 'categories_news_display', true ) ) {
	...
	<!-- main-content area-->
	<?php
	if ( get_theme_mod( 'archive_news_display', true ) ) {
