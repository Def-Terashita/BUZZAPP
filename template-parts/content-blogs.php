...
<div class="single-post">
	<div class="info">
		<ul class="list-inline">
			...
			<li>
				...
				<?php comments_popup_link( __( 'zero comment', 'd-kaigi' ), __( 'one comment', 'd-kaigi' ), '% ' . __( 'comments', 'd-kaigi' ) ); ?>
			</li>
		</ul>
	</div>
	<div class="post-content">
		...
		<div class="bottom-info">
			<a href="<?php the_permalink(); ?>" rel="bookmark" title="" class="btn btn-primary pull-left">
