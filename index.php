...
<?php
$offset_archive_news = '';
if ( get_theme_mod( 'banner_news_display', true ) && ! get_theme_mod( 'banner_news_category' ) ) {
		$offset_archive_news = 3;
}

$paged                  = ( get_query_var( 'paged' ) ) ? absint( get_query_var( 'paged' ) ) : 1;
$default_posts_per_page = get_option( 'posts_per_page' );
$offset                 = $default_posts_per_page * ( $paged - 1 );
$args                   = array(
	'post_type' => 'post',
	'offset'    => $offset,
	'paged'     => $paged,
...
<div class="inside-page post-list home-archive">
	<div class="container">
		<?php
		if ( ! $paged || $paged < 2 ) {
			echo esc_html__( 'Breaking News', 'd-kaigi' );
		};
		?>
		<div class="row">
			<div  class="col-sm-8">
