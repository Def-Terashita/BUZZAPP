...
if ( ! class_exists( 'd_kaigi_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class D_Kaigi_Slider_Control extends Wp_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style(
				'd-kaigi-slider',
				get_template_directory_uri() . '/inc/custom-controls/slider/slider.css',
				null
			);
			wp_enqueue_script(
				'd-kaigi-slider',
				get_template_directory_uri() . '/inc/custom-controls/slider/slider.js',
				array( 'jquery' ),
				false,
				true
			); // for slider.
