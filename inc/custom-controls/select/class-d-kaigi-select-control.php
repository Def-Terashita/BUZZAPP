<?php
/**
 * Customizer Control: d-kaigi-select.
 *
 * @package d-kaigi
 */
...
if ( ! class_exists( 'd_kaigi_Select_Control' ) ) {

	/**
	 * Select control.
	 */
	class D_Kaigi_Select_Control extends Wp_Customize_Control {
		/**
		 * Contorl type variable
		 *
		 * @var string
		 */
		public $type = 'd-kaigi-select';
		...
		public function enqueue() {
			wp_enqueue_style(
				'd-kaigi-selectize',
				get_template_directory_uri() . '/inc/custom-controls/select/select.css',
				null
			);
			wp_enqueue_script(
				'd-kaigi-selectize',
				get_template_directory_uri() . '/inc/js/selectize.js',
				array( 'jquery' )
			); // for multi select.
			wp_enqueue_script(
				'd-kaigi-select',
				get_template_directory_uri() . '/inc/custom-controls/select/select.js',
