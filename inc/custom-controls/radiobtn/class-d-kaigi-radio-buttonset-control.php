...
if ( ! class_exists( 'd_kaigi_Radio_Buttonset_Control' ) ) {

	/**
	 * Radio Buttonset control (modified radio)
	 */
	class D_Kaigi_Radio_Buttonset_Control extends Wp_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style(
				'd-kaigi-radio-btn',
				get_template_directory_uri() . '/inc/custom-controls/radiobtn/radio-btn.css',
				null
			);
			wp_enqueue_script(
				'd-kaigi-radio-buttonset',
				get_template_directory_uri() . '/inc/custom-controls/radiobtn/radio-buttonset.js',
				array( 'jquery' ),
				false,
				true
			); // for radio buttonset.
