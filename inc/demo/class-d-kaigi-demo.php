...
if ( ! class_exists( 'd_kaigi_Demo' ) ) {
	...
	class d_kaigi_Demo {
		...
		/**
		 * Singleton instance of d_kaigi_Demo.
		 *
		 * @var d_kaigi_Demo $instance d_kaigi_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof d_kaigi_Demo ) ) {
				self::$instance = new d_kaigi_Demo();
